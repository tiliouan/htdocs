...
if ( ! class_exists( 'YITH_WCAN_Sessions_Factory' ) ) {
	/**
	 * Session factory class.
	 */
	class YITH_WCAN_Sessions_Factory {
		...
		public static function get_session_query_param() {
			/**
			 * APPLY_FILTERS: yith_wcan_session_query_param
			 *
			 * Filters parameters used to store filter session id
			 *
			 * @param string $param Filter session param.
			 *
			 * @return string
			 */
	...
	class_alias( 'YITH_WCAN_Sessions_Factory', 'YITH_WCAN_Session_Factory' );
}
