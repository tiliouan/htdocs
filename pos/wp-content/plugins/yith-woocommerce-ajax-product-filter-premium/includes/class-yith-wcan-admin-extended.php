...
if ( ! class_exists( 'YITH_WCAN_Admin_Extended' ) ) {
	...
	class YITH_WCAN_Admin_Extended extends YITH_WCAN_Admin {
		...
		public function add_general_options( $settings ) {
			...
			$options = yith_wcan_merge_in_array( $options, $additional_options_batch_2, 'general_section_end', 'before' );
			...
			$options = yith_wcan_merge_in_array( $options, $additional_options_batch_3, 'hide_out_of_stock' );
