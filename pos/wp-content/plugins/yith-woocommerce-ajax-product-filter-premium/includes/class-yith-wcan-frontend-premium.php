...
if ( ! class_exists( 'YITH_WCAN_Frontend_Premium' ) ) {
	...
	class YITH_WCAN_Frontend_Premium extends YITH_WCAN_Frontend_Extended {
		...
		public function __construct() {
			...
			// init variations filtering class.
			YITH_WCAN_Variations_Filtering::instance();
		...
		public function enqueue_styles_scripts() {
			...
			if ( yith_wcan_can_be_displayed() ) {
				...
				$options = array(
					...
					/**
					 * APPLY_FILTERS: yith_wcan_dropdown_type
					 *
					 * Filters style used for price filter toggle (legacy).
					 *
					 * @param string $dropdown_style Dropdown style.
					 *
					 * @return string
					 */
					...
					/**
					 * APPLY_FILTERS: yith_wcan_dropdown_class
					 *
					 * Filters class used for price filter toggle (legacy).
					 *
					 * @param string $dropdown_class Dropdown class.
					 *
					 * @return string
					 */
		...
		public function body_class( $classes ) {
			...
			/**
			 * APPLY_FILTERS: yith_wcan_show_mobile_modal_opener
			 *
			 * Whether to show mobile filters' modal opener or not.
			 *
			 * @param bool $show_opener Whether to show opener button.
			 *
			 * @return bool
			 */
		...
		protected function get_shortcodes_localize( $context = 'view' ) {
			...
			if ( 'view' === $context ) {
				 ...
				 *
				 * @param array $script_args List of script parameters.
				 *
				 * @return array
				 */
		...
		public function filters_title( $preset = false ) {
			...
			if ( empty( $title ) ) {
				/**
				 * APPLY_FILTERS: yith_wcan_default_modal_title
				 *
				 * Filters default filters' modal's title.
				 *
			...
			/**
			 * APPLY_FILTERS: yith_wcan_preset_title_tag
			 *
			 * Filters tag used to render preset title.
			 *
			 * @param string $title_tag Preset title tag.
			 *
			 * @return string
			 */
			...
			/**
			 * APPLY_FILTERS: yith_wcan_preset_title_classes
			 *
			 * List of classes used for preset title tab.
			 *
			 * @param array $classes List of preset title classes.
			 *
			 * @return array
			 */
		...
		public function active_filters_list( $preset = false ) {
			...
			/**
			 * APPLY_FILTERS: yith_wcan_active_filters_title
			 *
			 * Filters title used for "Active filters" section.
			 *
			 * @param string $title Active filters title.
			 *
			 * @return string
			 */
		...
		public function mobile_modal_opener( $preset = false ) {
			...
			/**
			 * APPLY_FILTERS: yith_wcan_mobile_modal_opener_label
			 *
			 * Label used in "Modal opener" button.
			 *
			 * @param string $opener_label Button label.
			 *
			 * @return string
			 */
