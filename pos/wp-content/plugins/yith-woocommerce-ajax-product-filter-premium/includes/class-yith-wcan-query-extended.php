...
if ( ! class_exists( 'YITH_WCAN_Query_Extended' ) ) {
	...
	class YITH_WCAN_Query_Extended extends YITH_WCAN_Query {
		...
		public function should_filter() {
			 ...
			 * @return bool
			 */
			return apply_filters( 'yith_wcan_should_filter', ! ! YITH_WCAN_Sessions_Factory::get_session_query_var(), $this );
		}
		...
		public function maybe_retrieve_current_session() {
			...
			/**
			 * APPLY_FILTERS: yith_wcan_sessions_enabled
			 *
			 * Filter whether filter by session is enabled or not
			 *
			 * @param bool $enabled Whether filter by session is enabled or not
			 *
			 * @return bool
			 */
			...
			$session = YITH_WCAN_Sessions_Factory::get_current_session();
		...
		public function maybe_register_current_session( $origin_url, $query_vars ) {
			...
			$this->session = YITH_WCAN_Sessions_Factory::generate_session( $origin_url, $query_vars );
		}
